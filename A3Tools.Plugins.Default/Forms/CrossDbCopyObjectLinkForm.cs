...
public partial class CrossDbCopyObjectLinkForm : Form
{
        ...
        return await Task.Run(() =>
        {
            try
            {
                ...
                for (int i = 0; i < codes.Length; i++)
                {
                    ...
                    var mainGuid = GetObjectLinkGuid(srcConn, code);
    ...
    private string? GetObjectLinkGuid(SqlConnection conn, string code)
    {
        var sql = "SELECT GUID FROM dbo.S_OBJECTLINK WHERE CODE = @code";
