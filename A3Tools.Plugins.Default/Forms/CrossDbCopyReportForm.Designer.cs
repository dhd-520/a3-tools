...
partial class CrossDbCopyReportForm
{
    ...
    private Label lblReportCodeHint;
    ...
    private void InitializeComponent()
    {
        ...
        lblReportCode = new Label();
        txtReportCode = new TextBox();
        rowHintAndCheckbox = new TableLayoutPanel();
        lblReportCodeHint = new Label();
        ...
        mainLayout.Controls.Add(lblReportCode, 0, 1);
        mainLayout.Controls.Add(txtReportCode, 0, 2);
        ...
        // lblReportCode
        // 
        lblReportCode.Dock = DockStyle.Fill;
        lblReportCode.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
        lblReportCode.Location = new Point(3, 300);
        lblReportCode.Name = "lblReportCode";
        lblReportCode.Size = new Size(1250, 30);
        lblReportCode.TabIndex = 2;
        lblReportCode.Text = "报表CODE（多个用分号隔开）：";
        // 
        // txtReportCode
        // 
        txtReportCode.Dock = DockStyle.Fill;
        txtReportCode.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
        txtReportCode.Location = new Point(3, 333);
        txtReportCode.Multiline = true;
        txtReportCode.Name = "txtReportCode";
        txtReportCode.Size = new Size(1250, 94);
        txtReportCode.TabIndex = 14;
        // 
        // rowHintAndCheckbox
        // 
        rowHintAndCheckbox.ColumnCount = 2;
        rowHintAndCheckbox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
        rowHintAndCheckbox.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 717F));
        rowHintAndCheckbox.Controls.Add(lblReportCodeHint, 0, 0);
        ...
        rowHintAndCheckbox.Location = new Point(3, 433);
        ...
        // lblReportCodeHint
        // 
        lblReportCodeHint.Font = new Font("微软雅黑", 9F, FontStyle.Regular, GraphicsUnit.Point);
        lblReportCodeHint.ForeColor = Color.Gray;
        lblReportCodeHint.Location = new Point(3, 0);
        lblReportCodeHint.Name = "lblReportCodeHint";
        lblReportCodeHint.Size = new Size(766, 38);
        lblReportCodeHint.TabIndex = 3;
        lblReportCodeHint.Text = "提示：输入S_REPORT表的CODE，多个用英文分号;隔开，可通过下方搜索添加";
        // 
        // chkDeleteFirst
        // 
        ...
        chkDeleteFirst.Size = new Size(208, 32);
        ...
        pnlButtons.Location = new Point(3, 477);
        ...
        txtSearchKeyword.PlaceholderText = "输入报表代码或名称...";
