...
partial class CrossDbCopyAppChartForm
{
    ...
    private Label lblAppChartCode;
    private TextBox txtAppChartCode;
    private TableLayoutPanel rowHintAndCheckbox;
    private Label lblAppChartCodeHint;
    ...
    private void InitializeComponent()
    {
        ...
        lblAppChartCode = new Label();
        txtAppChartCode = new TextBox();
        rowHintAndCheckbox = new TableLayoutPanel();
        lblAppChartCodeHint = new Label();
        ...
        mainLayout.Controls.Add(lblAppChartCode, 0, 1);
        mainLayout.Controls.Add(txtAppChartCode, 0, 2);
        mainLayout.Controls.Add(rowHintAndCheckbox, 0, 3);
        mainLayout.Controls.Add(pnlButtons, 0, 4);
        mainLayout.Controls.Add(progressBar, 0, 5);
        mainLayout.Controls.Add(lblProgress, 0, 6);
        mainLayout.Controls.Add(pnlSearch, 0, 7);
        ...
        mainLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 91F));
        mainLayout.RowStyles.Add(new RowStyle(SizeType.Absolute, 49F));
        ...
        // lblAppChartCode
        // 
        lblAppChartCode.Dock = DockStyle.Fill;
        lblAppChartCode.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
        lblAppChartCode.Location = new Point(3, 300);
        lblAppChartCode.Name = "lblAppChartCode";
        lblAppChartCode.Size = new Size(1250, 30);
        lblAppChartCode.TabIndex = 2;
        lblAppChartCode.Text = "看板CODE（多个用分号隔开）：";
        // 
        // txtAppChartCode
        // 
        txtAppChartCode.Dock = DockStyle.Fill;
        txtAppChartCode.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
        txtAppChartCode.Location = new Point(3, 333);
        txtAppChartCode.Multiline = true;
        txtAppChartCode.Name = "txtAppChartCode";
        txtAppChartCode.Size = new Size(1250, 85);
        txtAppChartCode.TabIndex = 14;
        // 
        // rowHintAndCheckbox
        // 
        rowHintAndCheckbox.ColumnCount = 2;
        rowHintAndCheckbox.ColumnStyles.Add(new ColumnStyle(SizeType.Percent, 100F));
        rowHintAndCheckbox.ColumnStyles.Add(new ColumnStyle(SizeType.Absolute, 270F));
        rowHintAndCheckbox.Controls.Add(lblAppChartCodeHint, 0, 0);
        rowHintAndCheckbox.Controls.Add(chkDeleteFirst, 1, 0);
        rowHintAndCheckbox.Dock = DockStyle.Fill;
        rowHintAndCheckbox.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
        rowHintAndCheckbox.Location = new Point(3, 424);
        ...
        rowHintAndCheckbox.Size = new Size(1250, 43);
        rowHintAndCheckbox.TabIndex = 15;
        // 
        // lblAppChartCodeHint
        // 
        lblAppChartCodeHint.Font = new Font("微软雅黑", 9F, FontStyle.Regular, GraphicsUnit.Point);
        lblAppChartCodeHint.ForeColor = Color.Gray;
        lblAppChartCodeHint.Location = new Point(3, 0);
        lblAppChartCodeHint.Name = "lblAppChartCodeHint";
        lblAppChartCodeHint.Size = new Size(974, 40);
        lblAppChartCodeHint.TabIndex = 3;
        lblAppChartCodeHint.Text = "提示：输入S_APP_CHART表的CODE，多个用英文分号;隔开，可通过下方搜索添加";
        // 
        // chkDeleteFirst
        // 
        ...
        chkDeleteFirst.Location = new Point(1039, 3);
        ...
        pnlButtons.Location = new Point(3, 473);
        ...
        progressBar.Location = new Point(3, 523);
        ...
        lblProgress.Location = new Point(3, 545);
        ...
        pnlSearch.Location = new Point(3, 573);
        ...
        txtSearchKeyword.PlaceholderText = "输入看板代码或名称...";
        ...
        dgvSearchResults.Size = new Size(1225, 303);
