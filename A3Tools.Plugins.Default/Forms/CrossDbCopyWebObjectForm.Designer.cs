...
partial class CrossDbCopyWebObjectForm
{
    ...
    private TextBox txtWebObjectCode;
    private TableLayoutPanel rowHintAndCheckbox;
    private Label lblCodeHint;
    ...
    private void InitializeComponent()
    {
        ...
        lblCode = new Label();
        txtWebObjectCode = new TextBox();
        rowHintAndCheckbox = new TableLayoutPanel();
        lblCodeHint = new Label();
        ...
        mainLayout.Controls.Add(txtWebObjectCode, 0, 2);
        ...
        lblCode.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
        lblCode.Location = new Point(3, 300);
        lblCode.Name = "lblCode";
        lblCode.Size = new Size(1250, 30);
        lblCode.TabIndex = 2;
        lblCode.Text = "WEB看板CODE（多个用分号隔开）：";
        // 
        // txtWebObjectCode
        // 
        txtWebObjectCode.Dock = DockStyle.Fill;
        txtWebObjectCode.Font = new Font("微软雅黑", 10F, FontStyle.Regular, GraphicsUnit.Point);
        txtWebObjectCode.Location = new Point(3, 333);
        txtWebObjectCode.Multiline = true;
        txtWebObjectCode.Name = "txtWebObjectCode";
        txtWebObjectCode.Size = new Size(1250, 89);
        txtWebObjectCode.TabIndex = 14;
        // 
        // rowHintAndCheckbox
        // 
        ...
        rowHintAndCheckbox.Controls.Add(lblCodeHint, 0, 0);
        ...
        rowHintAndCheckbox.Location = new Point(3, 428);
        ...
        rowHintAndCheckbox.Size = new Size(1250, 39);
        rowHintAndCheckbox.TabIndex = 15;
        // 
        // lblCodeHint
        // 
        lblCodeHint.Dock = DockStyle.Fill;
        lblCodeHint.Font = new Font("微软雅黑", 9F, FontStyle.Regular, GraphicsUnit.Point);
        lblCodeHint.ForeColor = Color.Gray;
        lblCodeHint.Location = new Point(3, 0);
        lblCodeHint.Name = "lblCodeHint";
        lblCodeHint.Size = new Size(974, 39);
        lblCodeHint.TabIndex = 3;
        lblCodeHint.Text = "提示：输入S_WEBOBJECT表的CODE，多个用英文分号;隔开，可通过下方搜索添加";
        // 
        // chkDeleteFirst
        // 
        ...
        chkDeleteFirst.Size = new Size(208, 33);
        ...
        txtSearchKeyword.PlaceholderText = "输入WEB看板代码或名称...";
        ...
        dgvSearchResults.Size = new Size(1225, 298);
